            ...
            draw: function() {
                ...
                if (!isNaN(a)) {
                    ...
                    if (this.show) {
                        ...
                        x < h && (x = h);
                        x + z > l && (x = l - z);
                        var k = A + y, m = x + q, G = this.shadowAlpha, D = this.shadowColor, q = this.borderThickness, L = this.bulletSize, J, y = this.fillAlpha, M = this.borderAlpha;
                        this.showBullet && (J = d.circle(f, L, t, y),
                            g.push(J));
                        this.drop ? (h = z / 1.6,
                            l = 0,
                        "V" == u && (u = "down"),
                        ...
                        "right" == u && (l = 90,
                            ...
                            k = A - F / 2 + 1,
                            m = x - E / 2 - 1,
                            p = d.drop(f, h, l, p, y, q, r, M)) : 0 < w || 0 === B ? (0 < G && (a = d.rect(f, z, v, p, 0, q + 1, D, G, w),
                            d.isModern ? a.translate(1, 1) : a.translate(4, 4),
                            g.push(a)),
                            p = d.rect(f, z, v, p, y, q, r, M, w)) : (t = [],
                            w = [],
                            "H" != u ? (h = a - x,
                            h > z - B && (h = z - B),
                            h < B && (h = B),
                                t = [0, h - B, a - x, h + B, z, z, 0, 0],
                                w = H ? [0, 0, b - A, 0, 0, v, v, 0] : [v, v, b - A, v, v, 0, 0, v]) : (u = b - A,
                            u > v - B && (u = v - B),
                            u < B && (u = B),
                                w = [0, u - B, b - A, u + B, v, v, 0, 0],
                                t = a < h + (l - h) / 2 ? [0, 0, x < a ? 0 : a - x, 0, 0, z, z, 0] : [z, z, x + z > a ? z : a - x, z, z, 0, 0, z]),
                        0 < G && (a = d.polygon(f, t, w, p, 0, q, D, G),
                            a.translate(1, 1),
                            g.push(a)),
                            p = d.polygon(f, t, w, p, y, q, r, M));
                        this.bg = p;
                        g.push(p);
                        p.toFront();
...
(function() {
        ...
        d.bullet = function(a, b, c, e, f, g, h, k, l, m, n, p, r) {
            ...
            switch (b) {
                ...
                case "xError":
                    t = a.set(),
                        t.push(d.line(a, [-c / 2, c / 2], [0, 0], e, f, g)),
                        t.push(d.line(a, [-c / 2, -c / 2], [-l, l], e, f, g)),
                        t.push(d.line(a, [c / 2, c / 2], [-l, l], e, f, g))
            }
            t && t.pattern(n, NaN, p);
            return t
        ...
        d.handDrawnLine = function(a, b, c, e, f, g, h, k, l, m) {
            ...
            for (n = 1; n < b.length; n++)
                for (var r = [b[n - 1], b[n]], t = [c[n - 1], c[n]], t = d.makeHD(r, t, a.handDrawScatter), r = t[0], t = t[1], q = 1; q < r.length; q++)
                    p.push(d.line(a, [r[q - 1], r[q]], [t[q - 1], t[q]], e, f, g + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, h, k, l, m, !0));
            return p
        }
        ;
        ...
        d.wedge = function(a, b, c, e, f, g, h, k, l, m, n, p, r, t) {
            ...
            if (0 < l) {
                ...
                B ? (G || (D += " A" + (b - g) + "," + (l + c - h) + "," + (b + g) + "," + (l + c + h) + "," + A + "," + (C + l) + "," + x + "," + (z + l)),
                    D += " L" + E + "," + (w + l),
                0 < k && (G || (D += " B" + (b - k) + "," + (l + c - y) + "," + (b + k) + "," + (l + c + y) + "," + E + "," + (l + w) + "," + u + "," + (l + v)))) : (D += " A" + g + "," + h + ",0," + H + ",1," + x + "," + (z + l) + " L" + E + "," + (w + l),
            ...
            B ? (G || (f = " A" + q(b - g) + "," + q(c - h) + "," + q(b + g) + "," + q(c + h) + "," + q(A) + "," + q(C) + "," + q(x) + "," + q(z)),
                h = " M" + q(u) + "," + q(v) + " L" + q(A) + "," + q(C) + f + " L" + q(E) + "," + q(w)) : h = " M" + u + "," + v + " L" + A + "," + C + (" A" + g + "," + h + ",0," + H + ",1," + x + "," + z) + " L" + E + "," + w;
                    ...
                    if (e) {
                        ...
                        if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e)
                            ...
                            a.hidden || (g = a.lineColorR,
                                ...
                                t = d.line(p, [0, 2 * r], [r / 2, r / 2], g, a.lineAlpha, a.lineThickness, a.dashLength),
                                d.setCN(c, t, "graph-stroke"),
                                m.push(t),
                            a.bullet && (a.hidden || (g = a.bulletColorR),
                                t = d.bullet(p, a.bullet, a.bulletSize, g, a.bulletAlpha, a.bulletBorderThickness, k, a.bulletBorderAlpha)) && (d.setCN(c, t, "graph-bullet"),
                                t.translate(r + 1, r / 2),
                                m.push(t)),
                                y = 0,
                                t = r,
                            ...
                            t = a.fillColorsR;
                            !0 === a.hidden && (t = g);
                            if (m = b.createMarker("rectangle", t, a.fillAlphas, a.lineThickness, g, a.lineAlpha, m, l, a.dashLength))
                                y = r,
                                    m.translate(y, r / 2);
                            t = r
                        }
                ...
                if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                    ...
                    if (a = b.mapContainer) {
                        ...
                        b.isDragging && (b.balloon.hide(0),
                            ...
                            c = a.x + (f - c),
                            e = a.y + (g - e),
                        b.preventDragOut && (r = -r * k + m / 2 - b.diffY * b.mapScale * k,
        ...
        d.ZoomControl = d.Class({
            ...
            init: function(a, b) {
                ...
                E && E.translate(f, 4 * f),
                    ...
                    y.init(b, f, f, k, l, m, n, p, r, t, w, v, A),
                    y.set.translate(0, f),
                ...
                c.panControlEnabled && (p = l = 0),
                    h.init(b, f, f, k, l, m, n, p, r, t, w, v, A),
                    c.panControlEnabled ? h.set.translate(f, f) : E && E.translate(0, 1.5 * f),
        ...
        d.AreasProcessor = d.Class({
            ...
            updateAllAreas: function() {
                ...
                for (n = 0; n < h.length; n++) {
                    ...
                    k.getAreasFromMap && !m[l.id] && (r = new d.MapArea(a.theme),
                        r.parentObject = k,
                        r.id = l.id,
                        r.outline = l.outline,
                        k.areas.push(r))
        ...
        d.ImagesProcessor = d.Class({
            ...
            createImage: function(a, b) {
                ...
                if (n) {
                    ...
                    q = E = 0;
                    a.centeredReal ? (isNaN(a.right) || (E = C * w),
                    isNaN(a.bottom) || (q = F * w)) : (E = C * w / 2,
                        q = F * w / 2);
                    D.translate(E, q, w, !0)
                } else
                    u ? (isNaN(C) && (C = 10),
                    ...
                    a.centeredReal && (E = isNaN(a.right) ? -C / 2 : C / 2,
                        ...
                        D.translate(E, q, NaN, !0))) : B && (D = e.path(B),
                            u = D.getBBox(),
                            a.centeredReal ? (E = -u.x * w - u.width * w / 2,
                            isNaN(a.right) || (E = -E),
                ...
                G = a.labelColorReal;
                !a.showAsSelected && c.selectedObject != a || void 0 == h || (D && D.setAttr("fill", h),
            ...
            updateSizeAndPosition: function(a) {
                ...
                var k = a.longitude, l = a.latitude, m = a.positionOnLine, h = a.imageLabel, n = this.chart.zoomLevel(), p, r;
                ...
                if (a.line && a.line.getCoordinates) {
                    ...
                    t && (k = b.coordinateToLongitude(t.x),
                        ...
                        p = t.x,
                        r = t.y,
                    a.animateAngle && (g = d.radiansToDegrees(t.angle)))
                }
                ...
                if (a.remainVisible || c.selectedObject == a.parentObject) {
                    ...
                    if (0 < v.length) {
                        ...
                        if ("none" != A) {
                            ...
                            "both" == A && (r = d.polygon(x, t, k, m, p, 1, m, p, void 0, !0),
                                z.push(r),
